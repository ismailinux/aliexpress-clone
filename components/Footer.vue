        ...
        <div class="max-w-[1200px] mx-auto px-4">
            <div class="md:flex gap-4 justify-between w-full">
                <div class="md:w-[50%] pt-4">
                    ...
                    <div class="text-[#999999] text-sm">Help Center, Disputes & Reports, Buyer Protection, Report IPR infringement, Regulated Information, Integrity Compliance, Transparency Center, Submit report (non-registered users) </div>
                </div>
                <div class="md:w-[50%] pt-4">
            ...
            <div class="md:flex gap-4 justify-between w-full">
                <div class="md:w-[50%] pt-4">
                    ...
                    All Popular, Product, Promotion, Low Price, Great Value, Reviews, Blog </div>
                </div>
                <div class="md:w-[50%] pt-4">
